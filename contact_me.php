...
if($_POST)
{
    $to_email       = "sales@sonattaonella.com"; //Recipient email, Replace with own email here
    $from_email       = "project@sonattaonella.com"; //From email, most emails won't work without it.
